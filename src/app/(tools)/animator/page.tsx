  ...
  return (
    <div className="w-full max-w-4xl flex flex-col items-center gap-8">
      <div className="text-center space-y-2">
        <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-300 text-xs font-mono">
          <Film size={13} />
          <span>High-Density Frame-Delta Animation Optimizer</span>
        </div>
        <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-white">
          Animated WebP & GIF Diff Optimizer
        </h1>
        <p className="text-zinc-400 text-sm max-w-xl mx-auto">
          Convert video clips to ultra-compact animated WebP and GIF files using temporal frame differencing and adaptive color quantization.
        </p>
      </div>
