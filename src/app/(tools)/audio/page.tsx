      ...
      {!file ? (
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-6 font-mono text-xs">
          ...
          <div className="md:col-span-2 bg-[#09090c] border border-white/[0.08] rounded-xl p-5 flex flex-col justify-between min-h-[380px]">
            ...
            {downloadUrl ? (
              <div className="p-5 bg-[#0e0e14] border border-zinc-100/30 rounded-xl flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 gap-4 pt-2 border-t border-white/[0.06]">
                  ...
                  <div>
                    ...
                    <span className="text-white tabular-nums font-bold">{formatBytes(resultSize)}</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 pt-2">
                  ...
                  <a
                    href={downloadUrl}
                    download={outputName}
                    className="inline-flex items-center gap-2 px-5 py-2 rounded-md bg-white text-black font-semibold text-xs hover:bg-white transition-colors shadow"
                  >
                    <Download size={14} />
