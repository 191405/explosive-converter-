    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[130] flex items-center justify-center p-4 sm:p-6 bg-black/70 backdrop-blur-md">
        <motion.div
          ...
          className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto bg-[var(--bg-tile)] border border-black/10 dark:border-white/[0.12] rounded-2xl shadow-2xl flex flex-col"
        >
          {/* Header */}
